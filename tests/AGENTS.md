...
- `mission_control_test.mjs`: focused Mission Control coverage for config validation, localhost URL policy, LM Studio model parsing, live API config/probe behavior, and registered tracked-app start or stop flow
